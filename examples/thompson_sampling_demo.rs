...
use bizra_genesis_node::models::{
    CompletionOptions, CompletionResponse, FinishReason, ModelError, ModelProvider, ModelResult,
    ThompsonConfig, ThompsonSamplingRouter, TokenUsage,
};
use std::error::Error;
use std::sync::Arc;
...
impl ModelProvider for MockProvider {
    ...
    async fn list_models(&self) -> ModelResult<Vec<super::super::models::ModelInfo>> {
        Ok(vec![])
    }

    async fn health_check(&self) -> ModelResult<super::super::models::ProviderHealth> {
        Ok(super::super::models::ProviderHealth {
            status: super::super::models::HealthStatus::Healthy,
            latency_ms: Some(10),
            error: None,
        })
    }
