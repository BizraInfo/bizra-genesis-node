...
-- Users table extension (add columns if not exists)
ALTER TABLE users ADD COLUMN IF NOT EXISTS is_alpha_user BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS alpha_position INTEGER;
...
GRANT SELECT, INSERT, UPDATE ON alpha_requests TO bizra_user;
GRANT SELECT, INSERT, UPDATE ON alpha_invites TO bizra_user;
GRANT SELECT, INSERT, UPDATE ON users TO bizra_user;

-- Grant permissions on views
GRANT SELECT ON alpha_program_analytics TO bizra_user;
