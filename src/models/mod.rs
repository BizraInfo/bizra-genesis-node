...
pub use circuit_breaker::{
    with_circuit_breaker, CircuitBreaker, CircuitBreakerConfig, CircuitBreakerMetrics,
...
mod tests {
    ...
    #[test]
    fn test_constants() {
        // Constants are defined as positive values
        assert_eq!(DEFAULT_TIMEOUT_SECS, 30);
        assert_eq!(DEFAULT_MAX_RETRIES, 3);
        assert_eq!(MAX_CONTEXT_LENGTH, 128_000);
    }
}
